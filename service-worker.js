const CACHE = 'ergofit-v2';
const CORE = [
  './','./index.html','./manifest.json','./assets/css/styles.css','./assets/js/app.js','./assets/js/supabase-config.js','./assets/js/cloud-sync.js','./assets/images/logo.svg','./registro/','./registro/index.html','./registro/styles.css','./registro/app.js'
];
